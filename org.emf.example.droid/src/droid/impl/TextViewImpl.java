 ...
 * <ul>
 *   <li>{@link droid.impl.TextViewImpl#getText <em>Text</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getFadeScrollBars <em>Fade Scroll Bars</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getIsScrollContainer <em>Is Scroll Container</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getAutoLink <em>Auto Link</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getAutoText <em>Auto Text</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getCapitalize <em>Capitalize</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getDigits <em>Digits</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getEditable <em>Editable</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getGravity <em>Gravity</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getHint <em>Hint</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getNumeric <em>Numeric</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getPhoneNumber <em>Phone Number</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getSingleLine <em>Single Line</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getTextColor <em>Text Color</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getTypeface <em>Typeface</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getTextSize <em>Text Size</em>}</li>
 *   <li>{@link droid.impl.TextViewImpl#getTextStyle <em>Text Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
