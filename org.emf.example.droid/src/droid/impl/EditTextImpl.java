 ...
 * <ul>
 *   <li>{@link droid.impl.EditTextImpl#getText <em>Text</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getFadeScrollBars <em>Fade Scroll Bars</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getIsScrollContainer <em>Is Scroll Container</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getAutoLink <em>Auto Link</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getAutoText <em>Auto Text</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getCapitalize <em>Capitalize</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getDigits <em>Digits</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getEditable <em>Editable</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getGravity <em>Gravity</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getHint <em>Hint</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getNumeric <em>Numeric</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getPhoneNumber <em>Phone Number</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getSingleLine <em>Single Line</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getTextColor <em>Text Color</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getTypeface <em>Typeface</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getTextSize <em>Text Size</em>}</li>
 *   <li>{@link droid.impl.EditTextImpl#getTextStyle <em>Text Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
