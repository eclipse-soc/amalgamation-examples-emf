 ...
 * <ul>
 *   <li>{@link droid.impl.ApplicationImpl#getName <em>Name</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getPackageName <em>Package Name</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getVersionCode <em>Version Code</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getVersionName <em>Version Name</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getSdkVersion <em>Sdk Version</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getScreens <em>Screens</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getLayouts <em>Layouts</em>}</li>
 *   <li>{@link droid.impl.ApplicationImpl#getResources <em>Resources</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplicationImpl extends EObjectImpl implements Application {
	...
	public EList<Screen> getScreens() {
		if (screens == null) {
			screens = new EObjectContainmentEList<Screen>(Screen.class, this, DroidPackage.APPLICATION__SCREENS);
		}
		return screens;
	}
