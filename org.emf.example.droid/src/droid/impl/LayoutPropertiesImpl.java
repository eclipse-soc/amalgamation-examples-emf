 ...
 * <ul>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_height <em>Layout height</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_width <em>Layout width</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_weight <em>Layout weight</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_marginBottom <em>Layout margin Bottom</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_marginLeft <em>Layout margin Left</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_marginRight <em>Layout margin Right</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_marginTop <em>Layout margin Top</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_above <em>Layout above</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignBaseline <em>Layout align Baseline</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignBottom <em>Layout align Bottom</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignLeft <em>Layout align Left</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignParentBottom <em>Layout align Parent Bottom</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignParentLeft <em>Layout align Parent Left</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignParentRight <em>Layout align Parent Right</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignParentTop <em>Layout align Parent Top</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignTop <em>Layout align Top</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_alignWithParentIfMissing <em>Layout align With Parent If Missing</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_below <em>Layout below</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_centerHorizontal <em>Layout center Horizontal</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_centerInParent <em>Layout center In Parent</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_centerVertical <em>Layout center Vertical</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_toLeftOf <em>Layout to Left Of</em>}</li>
 *   <li>{@link droid.impl.LayoutPropertiesImpl#getLayout_toRightOf <em>Layout to Right Of</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LayoutPropertiesImpl extends EObjectImpl implements LayoutProperties {
	/**
	...
	protected EClass eStaticClass() {
		return DroidPackage.Literals.LAYOUT_PROPERTIES;
	}
	...
	public NotificationChain basicSetLayout_height(LayoutDimensionVA newLayout_height, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_HEIGHT, oldLayout_height, newLayout_height);
	...
	public void setLayout_height(LayoutDimensionVA newLayout_height) {
		if (newLayout_height != layout_height) {
			...
			if (layout_height != null)
				msgs = ((InternalEObject)layout_height).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_HEIGHT, null, msgs);
			if (newLayout_height != null)
				msgs = ((InternalEObject)newLayout_height).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_HEIGHT, null, msgs);
			msgs = basicSetLayout_height(newLayout_height, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_HEIGHT, newLayout_height, newLayout_height));
	}
	...
	public NotificationChain basicSetLayout_width(LayoutDimensionVA newLayout_width, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WIDTH, oldLayout_width, newLayout_width);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_width(LayoutDimensionVA newLayout_width) {
		if (newLayout_width != layout_width) {
			...
			if (layout_width != null)
				msgs = ((InternalEObject)layout_width).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WIDTH, null, msgs);
			if (newLayout_width != null)
				msgs = ((InternalEObject)newLayout_width).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WIDTH, null, msgs);
			msgs = basicSetLayout_width(newLayout_width, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WIDTH, newLayout_width, newLayout_width));
	}
	...
	public NotificationChain basicSetLayout_weight(IntegerVA newLayout_weight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WEIGHT, oldLayout_weight, newLayout_weight);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_weight(IntegerVA newLayout_weight) {
		if (newLayout_weight != layout_weight) {
			...
			if (layout_weight != null)
				msgs = ((InternalEObject)layout_weight).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WEIGHT, null, msgs);
			if (newLayout_weight != null)
				msgs = ((InternalEObject)newLayout_weight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WEIGHT, null, msgs);
			msgs = basicSetLayout_weight(newLayout_weight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_WEIGHT, newLayout_weight, newLayout_weight));
	}
	...
	public NotificationChain basicSetLayout_marginBottom(DimensionVA newLayout_marginBottom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_BOTTOM, oldLayout_marginBottom, newLayout_marginBottom);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_marginBottom(DimensionVA newLayout_marginBottom) {
		if (newLayout_marginBottom != layout_marginBottom) {
			...
			if (layout_marginBottom != null)
				msgs = ((InternalEObject)layout_marginBottom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_BOTTOM, null, msgs);
			if (newLayout_marginBottom != null)
				msgs = ((InternalEObject)newLayout_marginBottom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_BOTTOM, null, msgs);
			msgs = basicSetLayout_marginBottom(newLayout_marginBottom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_BOTTOM, newLayout_marginBottom, newLayout_marginBottom));
	}
	...
	public NotificationChain basicSetLayout_marginLeft(DimensionVA newLayout_marginLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_LEFT, oldLayout_marginLeft, newLayout_marginLeft);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_marginLeft(DimensionVA newLayout_marginLeft) {
		if (newLayout_marginLeft != layout_marginLeft) {
			...
			if (layout_marginLeft != null)
				msgs = ((InternalEObject)layout_marginLeft).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_LEFT, null, msgs);
			if (newLayout_marginLeft != null)
				msgs = ((InternalEObject)newLayout_marginLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_LEFT, null, msgs);
			msgs = basicSetLayout_marginLeft(newLayout_marginLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_LEFT, newLayout_marginLeft, newLayout_marginLeft));
	}
	...
	public NotificationChain basicSetLayout_marginRight(DimensionVA newLayout_marginRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_RIGHT, oldLayout_marginRight, newLayout_marginRight);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_marginRight(DimensionVA newLayout_marginRight) {
		if (newLayout_marginRight != layout_marginRight) {
			...
			if (layout_marginRight != null)
				msgs = ((InternalEObject)layout_marginRight).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_RIGHT, null, msgs);
			if (newLayout_marginRight != null)
				msgs = ((InternalEObject)newLayout_marginRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_RIGHT, null, msgs);
			msgs = basicSetLayout_marginRight(newLayout_marginRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_RIGHT, newLayout_marginRight, newLayout_marginRight));
	}
	...
	public NotificationChain basicSetLayout_marginTop(DimensionVA newLayout_marginTop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_TOP, oldLayout_marginTop, newLayout_marginTop);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_marginTop(DimensionVA newLayout_marginTop) {
		if (newLayout_marginTop != layout_marginTop) {
			...
			if (layout_marginTop != null)
				msgs = ((InternalEObject)layout_marginTop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_TOP, null, msgs);
			if (newLayout_marginTop != null)
				msgs = ((InternalEObject)newLayout_marginTop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_TOP, null, msgs);
			msgs = basicSetLayout_marginTop(newLayout_marginTop, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_MARGIN_TOP, newLayout_marginTop, newLayout_marginTop));
	}
	...
	public View getLayout_above() {
		if (layout_above != null && layout_above.eIsProxy()) {
			...
			if (layout_above != oldLayout_above) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ABOVE, oldLayout_above, layout_above));
			}
		}
		return layout_above;
	}
	...
	public void setLayout_above(View newLayout_above) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ABOVE, oldLayout_above, layout_above));
	}
	...
	public View getLayout_alignBaseline() {
		if (layout_alignBaseline != null && layout_alignBaseline.eIsProxy()) {
			...
			if (layout_alignBaseline != oldLayout_alignBaseline) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_BASELINE, oldLayout_alignBaseline, layout_alignBaseline));
			}
		}
	...
	public void setLayout_alignBaseline(View newLayout_alignBaseline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_BASELINE, oldLayout_alignBaseline, layout_alignBaseline));
	}
	...
	public View getLayout_alignBottom() {
		if (layout_alignBottom != null && layout_alignBottom.eIsProxy()) {
			...
			if (layout_alignBottom != oldLayout_alignBottom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_BOTTOM, oldLayout_alignBottom, layout_alignBottom));
			}
		}
	...
	public void setLayout_alignBottom(View newLayout_alignBottom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_BOTTOM, oldLayout_alignBottom, layout_alignBottom));
	}
	...
	public View getLayout_alignLeft() {
		if (layout_alignLeft != null && layout_alignLeft.eIsProxy()) {
			...
			if (layout_alignLeft != oldLayout_alignLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_LEFT, oldLayout_alignLeft, layout_alignLeft));
			}
		}
	...
	public void setLayout_alignLeft(View newLayout_alignLeft) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_LEFT, oldLayout_alignLeft, layout_alignLeft));
	}
	...
	public NotificationChain basicSetLayout_alignParentBottom(BooleanVA newLayout_alignParentBottom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_BOTTOM, oldLayout_alignParentBottom, newLayout_alignParentBottom);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_alignParentBottom(BooleanVA newLayout_alignParentBottom) {
		if (newLayout_alignParentBottom != layout_alignParentBottom) {
			...
			if (layout_alignParentBottom != null)
				msgs = ((InternalEObject)layout_alignParentBottom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_BOTTOM, null, msgs);
			if (newLayout_alignParentBottom != null)
				msgs = ((InternalEObject)newLayout_alignParentBottom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_BOTTOM, null, msgs);
			msgs = basicSetLayout_alignParentBottom(newLayout_alignParentBottom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_BOTTOM, newLayout_alignParentBottom, newLayout_alignParentBottom));
	}
	...
	public NotificationChain basicSetLayout_alignParentLeft(BooleanVA newLayout_alignParentLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_LEFT, oldLayout_alignParentLeft, newLayout_alignParentLeft);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_alignParentLeft(BooleanVA newLayout_alignParentLeft) {
		if (newLayout_alignParentLeft != layout_alignParentLeft) {
			...
			if (layout_alignParentLeft != null)
				msgs = ((InternalEObject)layout_alignParentLeft).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_LEFT, null, msgs);
			if (newLayout_alignParentLeft != null)
				msgs = ((InternalEObject)newLayout_alignParentLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_LEFT, null, msgs);
			msgs = basicSetLayout_alignParentLeft(newLayout_alignParentLeft, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_LEFT, newLayout_alignParentLeft, newLayout_alignParentLeft));
	}
	...
	public NotificationChain basicSetLayout_alignParentRight(BooleanVA newLayout_alignParentRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_RIGHT, oldLayout_alignParentRight, newLayout_alignParentRight);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_alignParentRight(BooleanVA newLayout_alignParentRight) {
		if (newLayout_alignParentRight != layout_alignParentRight) {
			...
			if (layout_alignParentRight != null)
				msgs = ((InternalEObject)layout_alignParentRight).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_RIGHT, null, msgs);
			if (newLayout_alignParentRight != null)
				msgs = ((InternalEObject)newLayout_alignParentRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_RIGHT, null, msgs);
			msgs = basicSetLayout_alignParentRight(newLayout_alignParentRight, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_RIGHT, newLayout_alignParentRight, newLayout_alignParentRight));
	}
	...
	public NotificationChain basicSetLayout_alignParentTop(BooleanVA newLayout_alignParentTop, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_TOP, oldLayout_alignParentTop, newLayout_alignParentTop);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_alignParentTop(BooleanVA newLayout_alignParentTop) {
		if (newLayout_alignParentTop != layout_alignParentTop) {
			...
			if (layout_alignParentTop != null)
				msgs = ((InternalEObject)layout_alignParentTop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_TOP, null, msgs);
			if (newLayout_alignParentTop != null)
				msgs = ((InternalEObject)newLayout_alignParentTop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_TOP, null, msgs);
			msgs = basicSetLayout_alignParentTop(newLayout_alignParentTop, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_PARENT_TOP, newLayout_alignParentTop, newLayout_alignParentTop));
	}
	...
	public View getLayout_alignTop() {
		if (layout_alignTop != null && layout_alignTop.eIsProxy()) {
			...
			if (layout_alignTop != oldLayout_alignTop) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_TOP, oldLayout_alignTop, layout_alignTop));
			}
		}
	...
	public void setLayout_alignTop(View newLayout_alignTop) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_TOP, oldLayout_alignTop, layout_alignTop));
	}
	...
	public NotificationChain basicSetLayout_alignWithParentIfMissing(BooleanVA newLayout_alignWithParentIfMissing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_WITH_PARENT_IF_MISSING, oldLayout_alignWithParentIfMissing, newLayout_alignWithParentIfMissing);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_alignWithParentIfMissing(BooleanVA newLayout_alignWithParentIfMissing) {
		if (newLayout_alignWithParentIfMissing != layout_alignWithParentIfMissing) {
			...
			if (layout_alignWithParentIfMissing != null)
				msgs = ((InternalEObject)layout_alignWithParentIfMissing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_WITH_PARENT_IF_MISSING, null, msgs);
			if (newLayout_alignWithParentIfMissing != null)
				msgs = ((InternalEObject)newLayout_alignWithParentIfMissing).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_WITH_PARENT_IF_MISSING, null, msgs);
			msgs = basicSetLayout_alignWithParentIfMissing(newLayout_alignWithParentIfMissing, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_WITH_PARENT_IF_MISSING, newLayout_alignWithParentIfMissing, newLayout_alignWithParentIfMissing));
	}
	...
	public View getLayout_below() {
		if (layout_below != null && layout_below.eIsProxy()) {
			...
			if (layout_below != oldLayout_below) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_BELOW, oldLayout_below, layout_below));
			}
		}
		return layout_below;
	}
	...
	public void setLayout_below(View newLayout_below) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_BELOW, oldLayout_below, layout_below));
	}
	...
	public NotificationChain basicSetLayout_centerHorizontal(BooleanVA newLayout_centerHorizontal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_HORIZONTAL, oldLayout_centerHorizontal, newLayout_centerHorizontal);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_centerHorizontal(BooleanVA newLayout_centerHorizontal) {
		if (newLayout_centerHorizontal != layout_centerHorizontal) {
			...
			if (layout_centerHorizontal != null)
				msgs = ((InternalEObject)layout_centerHorizontal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_HORIZONTAL, null, msgs);
			if (newLayout_centerHorizontal != null)
				msgs = ((InternalEObject)newLayout_centerHorizontal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_HORIZONTAL, null, msgs);
			msgs = basicSetLayout_centerHorizontal(newLayout_centerHorizontal, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_HORIZONTAL, newLayout_centerHorizontal, newLayout_centerHorizontal));
	}
	...
	public NotificationChain basicSetLayout_centerInParent(BooleanVA newLayout_centerInParent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_IN_PARENT, oldLayout_centerInParent, newLayout_centerInParent);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_centerInParent(BooleanVA newLayout_centerInParent) {
		if (newLayout_centerInParent != layout_centerInParent) {
			...
			if (layout_centerInParent != null)
				msgs = ((InternalEObject)layout_centerInParent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_IN_PARENT, null, msgs);
			if (newLayout_centerInParent != null)
				msgs = ((InternalEObject)newLayout_centerInParent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_IN_PARENT, null, msgs);
			msgs = basicSetLayout_centerInParent(newLayout_centerInParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_IN_PARENT, newLayout_centerInParent, newLayout_centerInParent));
	}
	...
	public NotificationChain basicSetLayout_centerVertical(BooleanVA newLayout_centerVertical, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_VERTICAL, oldLayout_centerVertical, newLayout_centerVertical);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout_centerVertical(BooleanVA newLayout_centerVertical) {
		if (newLayout_centerVertical != layout_centerVertical) {
			...
			if (layout_centerVertical != null)
				msgs = ((InternalEObject)layout_centerVertical).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_VERTICAL, null, msgs);
			if (newLayout_centerVertical != null)
				msgs = ((InternalEObject)newLayout_centerVertical).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_VERTICAL, null, msgs);
			msgs = basicSetLayout_centerVertical(newLayout_centerVertical, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_CENTER_VERTICAL, newLayout_centerVertical, newLayout_centerVertical));
	}
	...
	public View getLayout_toLeftOf() {
		if (layout_toLeftOf != null && layout_toLeftOf.eIsProxy()) {
			...
			if (layout_toLeftOf != oldLayout_toLeftOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_TO_LEFT_OF, oldLayout_toLeftOf, layout_toLeftOf));
			}
		}
	...
	public void setLayout_toLeftOf(View newLayout_toLeftOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_TO_LEFT_OF, oldLayout_toLeftOf, layout_toLeftOf));
	}
	...
	public View getLayout_toRightOf() {
		if (layout_toRightOf != null && layout_toRightOf.eIsProxy()) {
			...
			if (layout_toRightOf != oldLayout_toRightOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_TO_RIGHT_OF, oldLayout_toRightOf, layout_toRightOf));
			}
		}
	...
	public void setLayout_toRightOf(View newLayout_toRightOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DroidPackage.LAYOUT_PROPERTIES__LAYOUT_TO_RIGHT_OF, oldLayout_toRightOf, layout_toRightOf));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ABOVE:
				if (resolve) return getLayout_above();
				return basicGetLayout_above();
			case DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_BASELINE:
				if (resolve) return getLayout_alignBaseline();
				return basicGetLayout_alignBaseline();
			case DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_BOTTOM:
				if (resolve) return getLayout_alignBottom();
				return basicGetLayout_alignBottom();
			case DroidPackage.LAYOUT_PROPERTIES__LAYOUT_ALIGN_LEFT:
			...
			case DroidPackage.LAYOUT_PROPERTIES__LAYOUT_TO_LEFT_OF:
				if (resolve) return getLayout_toLeftOf();
				return basicGetLayout_toLeftOf();
			case DroidPackage.LAYOUT_PROPERTIES__LAYOUT_TO_RIGHT_OF:
