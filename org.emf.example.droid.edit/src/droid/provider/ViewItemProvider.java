...
/**
 * This is the item provider adapter for a {@link droid.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DroidPackage.Literals.VIEW__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.Literals.VIEW__BACKGROUND);
			childrenFeatures.add(DroidPackage.Literals.VIEW__ON_CLICK);
			childrenFeatures.add(DroidPackage.Literals.VIEW__LAYOUT_PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.VIEW__BACKGROUND,
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.VIEW__ON_CLICK,
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.VIEW__ON_CLICK,
				 DroidFactory.eINSTANCE.createInvokeScreenAction()));

		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.VIEW__LAYOUT_PROPERTIES,
				 DroidFactory.eINSTANCE.createLayoutProperties()));
	}
