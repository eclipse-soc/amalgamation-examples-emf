...
public class ImageViewItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.Literals.IMAGE_VIEW__SRC);
			childrenFeatures.add(DroidPackage.Literals.IMAGE_VIEW__FADE_SCROLL_BARS);
			childrenFeatures.add(DroidPackage.Literals.IMAGE_VIEW__IS_SCROLL_CONTAINER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.IMAGE_VIEW__SRC,
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.IMAGE_VIEW__FADE_SCROLL_BARS,
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.IMAGE_VIEW__IS_SCROLL_CONTAINER,
				 DroidFactory.eINSTANCE.createBooleanVA()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DroidPackage.Literals.IMAGE_VIEW__SRC ||
			...
			childFeature == DroidPackage.Literals.IMAGE_VIEW__FADE_SCROLL_BARS ||
			childFeature == DroidPackage.Literals.IMAGE_VIEW__IS_SCROLL_CONTAINER;
