...
public class DimensionVAItemProvider
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DimensionVA_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DimensionVA_value_feature", "_UI_DimensionVA_type"),
				 DroidPackage.Literals.DIMENSION_VA__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		LayoutDimensionKind labelValue = ((DimensionVA)object).getConst_value();
