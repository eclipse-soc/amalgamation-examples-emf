...
/**
 * This is the item provider adapter for a {@link droid.Spinner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpinnerItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DroidPackage.Literals.SPINNER__PROMPT);
			childrenFeatures.add(DroidPackage.Literals.SPINNER__FADE_SCROLL_BARS);
			childrenFeatures.add(DroidPackage.Literals.SPINNER__IS_SCROLL_CONTAINER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.SPINNER__PROMPT,
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.SPINNER__FADE_SCROLL_BARS,
		...
		newChildDescriptors.add
			(createChildParameter
				(DroidPackage.Literals.SPINNER__IS_SCROLL_CONTAINER,
				 DroidFactory.eINSTANCE.createBooleanVA()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DroidPackage.Literals.SPINNER__FADE_SCROLL_BARS ||
			childFeature == DroidPackage.Literals.SPINNER__IS_SCROLL_CONTAINER;
