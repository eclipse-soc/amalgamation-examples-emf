 ...
 * 
 */
public class DrawableRAPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DrawableRAPropertiesEditionPart {
	 ...
	 * 
	 */
	public DrawableRAPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(Composite view) { 
		...
		propertiesStep.addStep(DroidViewsRepository.DrawableRA.Properties.package_);
		...
		composer = new PartComposer(drawableRAStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == DroidViewsRepository.DrawableRA.Properties.package_) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(DroidMessages.DrawableRAPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPackage_Text(Composite parent) {
		SWTUtils.createPartLabel(parent, DroidMessages.DrawableRAPropertiesEditionPart_Package_Label, propertiesEditionComponent.isRequired(DroidViewsRepository.DrawableRA.Properties.package_, DroidViewsRepository.SWT_KIND));
		...
		package_.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DrawableRAPropertiesEditionPartImpl.this, DroidViewsRepository.DrawableRA.Properties.package_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, package_.getText()));
			}
		...
		EditingUtils.setID(package_, DroidViewsRepository.DrawableRA.Properties.package_);
		EditingUtils.setEEFtype(package_, "eef::Text"); //$NON-NLS-1$
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.DrawableRA.Properties.package_, DroidViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createExternalResourceText(Composite parent) {
		SWTUtils.createPartLabel(parent, DroidMessages.DrawableRAPropertiesEditionPart_ExternalResourceLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.DrawableRA.Properties.externalResource, DroidViewsRepository.SWT_KIND));
		...
		externalResource.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DrawableRAPropertiesEditionPartImpl.this, DroidViewsRepository.DrawableRA.Properties.externalResource, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, externalResource.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.DrawableRA.Properties.externalResource, DroidViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createResourceFlatComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, DroidMessages.DrawableRAPropertiesEditionPart_ResourceLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.DrawableRA.Properties.resource, DroidViewsRepository.SWT_KIND));
		resource = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.DrawableRA.Properties.resource, DroidViewsRepository.SWT_KIND));
		...
		resource.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DrawableRAPropertiesEditionPartImpl.this, DroidViewsRepository.DrawableRA.Properties.resource, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getResource()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.DrawableRA.Properties.resource, DroidViewsRepository.SWT_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.DrawableRAPropertiesEditionPart#getPackage_()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.DrawableRAPropertiesEditionPart#setPackage_(String newValue)
	 * 
	 */
