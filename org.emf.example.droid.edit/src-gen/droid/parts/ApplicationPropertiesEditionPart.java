...
public interface ApplicationPropertiesEditionPart {
	...
	/**
	 * Update the screens
	 * @param newValue the screens to update
	 * 
	 */
	public void updateScreens();

	/**
	 * Adds the given filter to the screens edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the screens table
	 * 
	 */
