...
public class BooleanRAPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, BooleanRAPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(DroidViewsRepository.BooleanRA.Properties.value);
		propertiesStep.addStep(DroidViewsRepository.BooleanRA.Properties.package_);
		...
		composer = new PartComposer(booleanRAStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == DroidViewsRepository.BooleanRA.Properties.value) {
					return 		createValueText(widgetFactory, parent);
				}
				if (key == DroidViewsRepository.BooleanRA.Properties.package_) {
	...
	protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.BooleanRAPropertiesEditionPart_ValueLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.BooleanRA.Properties.value, DroidViewsRepository.FORM_KIND));
		...
		value.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BooleanRAPropertiesEditionPartForm.this, DroidViewsRepository.BooleanRA.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, value.getText()));
			}
		});
		...
		EditingUtils.setID(value, DroidViewsRepository.BooleanRA.Properties.value);
		EditingUtils.setEEFtype(value, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.BooleanRA.Properties.value, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}

	
	protected Composite createPackage_Text(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.BooleanRAPropertiesEditionPart_Package_Label, propertiesEditionComponent.isRequired(DroidViewsRepository.BooleanRA.Properties.package_, DroidViewsRepository.FORM_KIND));
		...
		package_.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(BooleanRAPropertiesEditionPartForm.this, DroidViewsRepository.BooleanRA.Properties.package_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, package_.getText()));
			}
		});
		...
		EditingUtils.setID(package_, DroidViewsRepository.BooleanRA.Properties.package_);
		EditingUtils.setEEFtype(package_, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.BooleanRA.Properties.package_, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#getValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#setValue(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#getPackage_()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#setPackage_(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#getExternalResource()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#setExternalResource(String newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#getResource()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#initResource(EObjectFlatComboSettings)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#setResource(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#setResourceButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#addFilterResource(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see droid.parts.BooleanRAPropertiesEditionPart#addBusinessFilterResource(ViewerFilter filter)
	 * 
	 */
