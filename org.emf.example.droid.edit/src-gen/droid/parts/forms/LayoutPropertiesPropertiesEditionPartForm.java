 ...
 * 
 */
public class LayoutPropertiesPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, LayoutPropertiesPropertiesEditionPart {
	 ...
	 * 
	 */
	public LayoutPropertiesPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(DroidMessages.LayoutPropertiesPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createLayout_aboveFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_aboveLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_above, DroidViewsRepository.FORM_KIND));
		layout_above = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_above, DroidViewsRepository.FORM_KIND));
		...
		layout_above.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_above, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_above()));
			}

		});
		layout_above.setID(DroidViewsRepository.LayoutProperties.Properties.layout_above);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_above, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_alignBaselineFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_alignBaselineLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignBaseline, DroidViewsRepository.FORM_KIND));
		layout_alignBaseline = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignBaseline, DroidViewsRepository.FORM_KIND));
		...
		layout_alignBaseline.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_alignBaseline, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_alignBaseline()));
			}

		});
		layout_alignBaseline.setID(DroidViewsRepository.LayoutProperties.Properties.layout_alignBaseline);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_alignBaseline, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_alignBottomFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_alignBottomLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignBottom, DroidViewsRepository.FORM_KIND));
		layout_alignBottom = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignBottom, DroidViewsRepository.FORM_KIND));
		...
		layout_alignBottom.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_alignBottom, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_alignBottom()));
			}

		});
		layout_alignBottom.setID(DroidViewsRepository.LayoutProperties.Properties.layout_alignBottom);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_alignBottom, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_alignLeftFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_alignLeftLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignLeft, DroidViewsRepository.FORM_KIND));
		layout_alignLeft = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignLeft, DroidViewsRepository.FORM_KIND));
		...
		layout_alignLeft.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_alignLeft, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_alignLeft()));
			}

		});
		layout_alignLeft.setID(DroidViewsRepository.LayoutProperties.Properties.layout_alignLeft);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_alignLeft, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_alignTopFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_alignTopLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignTop, DroidViewsRepository.FORM_KIND));
		layout_alignTop = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_alignTop, DroidViewsRepository.FORM_KIND));
		...
		layout_alignTop.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_alignTop, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_alignTop()));
			}

		});
		layout_alignTop.setID(DroidViewsRepository.LayoutProperties.Properties.layout_alignTop);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_alignTop, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_belowFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_belowLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_below, DroidViewsRepository.FORM_KIND));
		layout_below = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_below, DroidViewsRepository.FORM_KIND));
		...
		layout_below.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_below, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_below()));
			}

		});
		layout_below.setID(DroidViewsRepository.LayoutProperties.Properties.layout_below);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_below, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_toLeftOfFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_toLeftOfLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_toLeftOf, DroidViewsRepository.FORM_KIND));
		layout_toLeftOf = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_toLeftOf, DroidViewsRepository.FORM_KIND));
		...
		layout_toLeftOf.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_toLeftOf, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_toLeftOf()));
			}

		});
		layout_toLeftOf.setID(DroidViewsRepository.LayoutProperties.Properties.layout_toLeftOf);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_toLeftOf, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
	...
	protected Composite createLayout_toRightOfFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		FormUtils.createPartLabel(widgetFactory, parent, DroidMessages.LayoutPropertiesPropertiesEditionPart_Layout_toRightOfLabel, propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_toRightOf, DroidViewsRepository.FORM_KIND));
		layout_toRightOf = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(DroidViewsRepository.LayoutProperties.Properties.layout_toRightOf, DroidViewsRepository.FORM_KIND));
		...
		layout_toRightOf.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LayoutPropertiesPropertiesEditionPartForm.this, DroidViewsRepository.LayoutProperties.Properties.layout_toRightOf, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLayout_toRightOf()));
			}

		});
		layout_toRightOf.setID(DroidViewsRepository.LayoutProperties.Properties.layout_toRightOf);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(DroidViewsRepository.LayoutProperties.Properties.layout_toRightOf, DroidViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		return parent;
	}
