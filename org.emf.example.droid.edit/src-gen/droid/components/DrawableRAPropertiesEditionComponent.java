...
public class DrawableRAPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (drawableRA.getPackage() != null && isAccessible(DroidViewsRepository.DrawableRA.Properties.package_))
				basePart.setPackage_(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), drawableRA.getPackage()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (DroidViewsRepository.DrawableRA.Properties.package_ == event.getAffectedEditor()) {
			drawableRA.setPackage((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (DroidPackage.eINSTANCE.getResourceAccess_Package().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.DrawableRA.Properties.package_)) {
			...
			if (DroidPackage.eINSTANCE.getResourceAccess_ExternalResource().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.DrawableRA.Properties.externalResource)) {
				if (msg.getNewValue() != null) {
