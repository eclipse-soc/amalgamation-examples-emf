...
import droid.parts.BooleanResourcePropertiesEditionPart;
...
public class BooleanResourcePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (booleanResource.getValue() != null && isAccessible(DroidViewsRepository.BooleanResource.Properties.value))
				basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), booleanResource.getValue()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (DroidViewsRepository.BooleanResource.Properties.value == event.getAffectedEditor()) {
			booleanResource.setValue((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	}
