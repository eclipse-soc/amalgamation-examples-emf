...
public class BooleanRAPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (booleanRA.getValue() != null && isAccessible(DroidViewsRepository.BooleanRA.Properties.value))
				basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), booleanRA.getValue()));
			
			if (booleanRA.getPackage() != null && isAccessible(DroidViewsRepository.BooleanRA.Properties.package_))
				basePart.setPackage_(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), booleanRA.getPackage()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (DroidViewsRepository.BooleanRA.Properties.value == event.getAffectedEditor()) {
			booleanRA.setValue((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (DroidViewsRepository.BooleanRA.Properties.package_ == event.getAffectedEditor()) {
			booleanRA.setPackage((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (DroidPackage.eINSTANCE.getBooleanVA_Value().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.BooleanRA.Properties.value)) {
			...
			if (DroidPackage.eINSTANCE.getResourceAccess_Package().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.BooleanRA.Properties.package_)) {
				if (msg.getNewValue() != null) {
			...
			if (DroidPackage.eINSTANCE.getResourceAccess_ExternalResource().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.BooleanRA.Properties.externalResource)) {
				if (msg.getNewValue() != null) {
