...
public class ApplicationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for screens ReferencesTable
	 */
	protected ReferencesTableSettings screensSettings;
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(DroidViewsRepository.Application.Properties.screens)) {
				screensSettings = new ReferencesTableSettings(application, DroidPackage.eINSTANCE.getApplication_Screens());
				basePart.initScreens(screensSettings);
			}
			...
			basePart.addFilterToScreens(new ViewerFilter() {
			...
			// Start of user code for additional businessfilters for screens
			// End of user code
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (DroidViewsRepository.Application.Properties.screens == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext, this, screensSettings, editingContext.getAdapterFactory());
				...
				if (provider != null) {
					...
					screensSettings.removeFromReference((EObject) event.getNewValue());
			}
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (DroidPackage.eINSTANCE.getApplication_Screens().equals(msg.getFeature()) && isAccessible(DroidViewsRepository.Application.Properties.screens))
				basePart.updateScreens();
