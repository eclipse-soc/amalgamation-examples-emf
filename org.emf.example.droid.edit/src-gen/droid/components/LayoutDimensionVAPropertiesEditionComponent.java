...
public class LayoutDimensionVAPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(DroidViewsRepository.LayoutDimensionVA.Properties.const_value)) {
				basePart.initConst_value((EEnum) DroidPackage.eINSTANCE.getLayoutDimensionVA_Const_value().getEType(), layoutDimensionVA.getConst_value());
			}
			// init filters
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (DroidViewsRepository.LayoutDimensionVA.Properties.const_value == event.getAffectedEditor()) {
			layoutDimensionVA.setConst_value((LayoutDimensionKind)event.getNewValue());
		}
	}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (DroidPackage.eINSTANCE.getLayoutDimensionVA_Const_value().equals(msg.getFeature()) && isAccessible(DroidViewsRepository.LayoutDimensionVA.Properties.const_value))
