...
public class ColorRAPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (colorRA.getValue() != null && isAccessible(DroidViewsRepository.ColorRA.Properties.value))
				basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), colorRA.getValue()));
			
			if (colorRA.getPackage() != null && isAccessible(DroidViewsRepository.ColorRA.Properties.package_))
				basePart.setPackage_(EEFConverterUtil.convertToString(EcorePackage.eINSTANCE.getEString(), colorRA.getPackage()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (DroidViewsRepository.ColorRA.Properties.value == event.getAffectedEditor()) {
			colorRA.setValue((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
		if (DroidViewsRepository.ColorRA.Properties.package_ == event.getAffectedEditor()) {
			colorRA.setPackage((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.eINSTANCE.getEString(), (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (DroidPackage.eINSTANCE.getColorVA_Value().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.ColorRA.Properties.value)) {
			...
			if (DroidPackage.eINSTANCE.getResourceAccess_Package().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.ColorRA.Properties.package_)) {
				if (msg.getNewValue() != null) {
			...
			if (DroidPackage.eINSTANCE.getResourceAccess_ExternalResource().equals(msg.getFeature()) && basePart != null && isAccessible(DroidViewsRepository.ColorRA.Properties.externalResource)) {
				if (msg.getNewValue() != null) {
